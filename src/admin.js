	...
	useLayoutEffect( () => {
		api.loadPromise.then( () => {
			...
			model.fetch().then( response => {
				if( response.custom_card_link_settings === undefined || response.custom_card_link_settings === null ) {
					...
					setSettings({
						...
						borderRadius: response.custom_card_link_settings.border_radius,
						titleFontSize: response.custom_card_link_settings.title_font_size,
						descriptionFontSize: response.custom_card_link_settings.description_font_size,
						titleNumOfChar: response.custom_card_link_settings.title_num_of_char,
						descriptionNumOfChar: response.custom_card_link_settings.description_num_of_char,
						gapBetweenTitleAndThumbnail: response.custom_card_link_settings.gap_between_title_and_thumbnail,
						descriptionMarginTop: response.custom_card_link_settings.description_margin_top,
						shadowUse: response.custom_card_link_settings.shadow_use,
						shadowOffsetX: response.custom_card_link_settings.shadow_offset_x,
						shadowOffsetY: response.custom_card_link_settings.shadow_offset_y,
						shadowBlurRadius: response.custom_card_link_settings.shadow_blur_radius,
						shadowSpreadRadius: response.custom_card_link_settings.shadow_spread_radius,
						shadowColor: response.custom_card_link_settings.shadow_color,
						breakpoint: response.custom_card_link_settings.breakpoint,
						layoutSp: response.custom_card_link_settings.layout_sp,
						maxWidthSp: response.custom_card_link_settings.max_width_sp,
						paddingSp: response.custom_card_link_settings.padding_sp,
						borderRadiusSp: response.custom_card_link_settings.border_radius_sp,
						titleFontSizeSp: response.custom_card_link_settings.title_font_size_sp,
						descriptionFontSizeSp: response.custom_card_link_settings.description_font_size_sp,
						titleNumOfCharSp: response.custom_card_link_settings.title_num_of_char_sp,
						descriptionNumOfCharSp: response.custom_card_link_settings.description_num_of_char_sp,
						gapBetweenTitleAndThumbnailSp: response.custom_card_link_settings.gap_between_title_and_thumbnail_sp,
						descriptionMarginTopSp: response.custom_card_link_settings.description_margin_top_sp,
						shadowUseSp: response.custom_card_link_settings.shadow_use_sp,
						shadowOffsetXSp: response.custom_card_link_settings.shadow_offset_x_sp,
						shadowOffsetYSp: response.custom_card_link_settings.shadow_offset_y_sp,
						shadowBlurRadiusSp: response.custom_card_link_settings.shadow_blur_radius_sp,
						shadowSpreadRadiusSp: response.custom_card_link_settings.shadow_spread_radius_sp,
						shadowColorSp: response.custom_card_link_settings.shadow_color_sp,
						hoverUse: response.custom_card_link_settings.hover_use,
						hoverTop: response.custom_card_link_settings.hover_top,
						hoverTransitionTime: response.custom_card_link_settings.hover_transition_time,
						hoverShadowOffsetX: response.custom_card_link_settings.hover_shadow_offset_x,
						hoverShadowOffsetY: response.custom_card_link_settings.hover_shadow_offset_y,
						hoverShadowBlurRadius: response.custom_card_link_settings.hover_shadow_blur_radius,
						hoverShadowSpreadRadius: response.custom_card_link_settings.hover_shadow_spread_radius,
						hoverShadowColor: response.custom_card_link_settings.hover_shadow_color,
					});
				}
			});
		});
		...
		api.loadPromise.then( () => {
			const model = new api.models.Settings({
				'custom_card_link_settings' : {
					...
					'gap_between_title_and_thumbnail_sp': settings.gapBetweenTitleAndThumbnailSp,
