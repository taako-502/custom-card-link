			...
			<div className='ccl-admin__container'>
				<div className='ccl-admin__inputs'>
					<RadioControl
						...
						onChange={ ( value ) => setSettings({...settings, layoutSp: value }) }
					/>
					<RangeControl
						label='最大横幅'
						value={ settings.maxWidthSp }
						onChange={ ( value ) => setSettings({...settings, maxWidthSp: value }) }
						min={ 200 }
						max={ 1200 }
					/>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, paddingSp: value }) }
						min={ 0 }
						max={ 40 }
					/>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, borderRadiusSp: value }) }
						min={ 0 }
						max={ 15 }
					/>
				</div>
				<div className='ccl-admin__inputs'>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, titleFontSizeSp: value }) }
						min={ 10 }
						max={ 30 }
					/>
					<RangeControl
					...
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, titleNumOfCharSp: value }) }
						min={ 10 }
						max={ 60 }
					/>
					<RangeControl
					...
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, gapBetweenTitleAndThumbnailSp: value }) }
						min={ 0 }
						max={ 30 }
					/>
					<RangeControl
			...
			<div className='ccl-admin__container'>
				<div className='ccl-admin__inputs'>
					<RadioControl
						...
						onChange={ ( value ) => setSettings({...settings, shadowUseSp: value }) }
					/>
					<label
					...
					<ColorPicker
						...
						onChange={ ( value ) => setSettings({...settings, shadowColorSp: value }) }
						enableAlpha
						style={ styleDisplayNone( settings.shadowUseSp ) }
					/>
				</div>
				...
				>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, shadowOffsetXSp: value }) }
						min={ -10 }
						max={ 10 }
					/>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, shadowOffsetYSp: value }) }
						min={ -10 }
						max={ 10 }
					/>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, shadowBlurRadiusSp: value }) }
						min={ 0 }
						max={ 10 }
					/>
					<RangeControl
						...
						onChange={ ( value ) => setSettings({...settings, shadowSpreadRadiusSp: value }) }
						min={ 0 }
						max={ 10 }
					/>
				</div>
